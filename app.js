...
$button.click(() => {
    ...
    var userNat = $("input:text").val();
    // $.get(`https://randomuser.me/api/?gender=${userInput.toLowerCase()}`, (data) => {
    //     console.log(data);
    //     // $wrapper.innerHTML = '';
    //     data.results.forEach((search) => {
    //         let div1 = $('<div class="person">');
    ...
    $.get(`https://randomuser.me/api/?nat=${userNat.toUpperCase()}&results=3`, (data) => {
        console.log(data);
        // $wrapper.innerHTML = '';
        data.results.forEach((search) => {
            let div1 = $('<div class="person">');
